...
public class TexFont {
	...
	public Boolean LoadFontAlt(String fontName, GL10 gl) throws IOException {
		...
		try {
			...
			// Log.d("TexFont LoadAlt", "Fnt text width: " + fntTexWidth);
			// Log.d("TexFont LoadAlt", "Fnt cell width: " + fntCellWidth);
			// Log.d("TexFont LoadAlt", "Col count: " + colCount);
	...
	public Boolean LoadFont(String fontName, GL10 gl) throws IOException {
		...
		// Log.d("TexFont Load", "Fnt text width: " + fntTexWidth);
		// Log.d("TexFont Load", "Fnt cell width: " + fntCellWidth);
		// Log.d("TexFont Load", "Col count: " + colCount);
	...
	public void PrintAt(GL10 gl, String text, int x, int y) {
		...
		for (int index = 0; index != text.length(); ++index) {
			...
			// Log.d("TexFont PrintAT", "glyph: " + glyph);
			// Log.d("TexFont PrintAT", "Col count: " + colCount);
