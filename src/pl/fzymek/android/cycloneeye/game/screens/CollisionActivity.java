...
public class CollisionActivity extends CEGame {

	public class CollisionsScreen extends Screen {
		...
		public CollisionsScreen(CEGame game) {
		        super(game);
	...
	public Screen getStartScreen() {
		return new CollisionsScreen(this);
	}
